...
void setup(){
    ...
    if(WT32_ETH01_isConnected()){
        HTTPClient http;
        http.begin("http://192.168.0.1:8090/api/collections/card_log/records");
        http.addHeader("Content-Type", "application/json");
        int httpCode = http.POST("{\"card_id\": \"15\"}");
...
void loop()
{
  if (WT32_ETH01_isConnected())
  {
    ...
    http.begin("http://192.168.0.1:8090/api/collections/card_log/records"); //HTTP
